<?php
// $Id: email.php,v 1.4 2006/03/10 00:40:48 andrew Exp $
//  ------------------------------------------------------------------------ //
//  Author: Andrew Mills                                                     //
...
if ($xoopsModuleConfig['allowemailtofriend'] != 1) {
	redirect_header(XOOPS_URL ."/modules/". $xoopsModule->getVar('dirname') ."/index.php", 2, _MD_EMAILNOTON);
	exit();
}
...
//echo $id;
	...
	$xoopsOption['template_main'] = 'event_email.html';
...
//print_r($formdata);
	...
	*/
		...
		*/
		...
		$message = preg_replace("/{ARTICLE_URL}/", XOOPS_URL . "/modules/". $xoopsModule->getVar('dirname') ."/index.php?id=" . $id, $message);
